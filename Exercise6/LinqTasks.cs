...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps.Where(e => { return e.Salary.Equals(Emps.Max(e1 => e1.Salary)); });
            return result;
        }
        ...
        {
            Emp result = Emps.First(e => e.Job.Equals("Frontend programmer"));
            return result;
        }
        ...
        {
            return Emps.TaskGetListOfSubordinates();
        }
        ...
        {
            var result = arr.GroupBy(i => i).Where(ints => ints.Count() % 2 != 0).Select(group => group.Key).First();
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
            {
                IEnumerable<Dept> result = Emps
                    .Join(Depts,
                        ...
                        d => d.Deptno,
                        (e, d) => new { e, d })
                    .GroupBy(ed => new { ed.d.Deptno, ed.d.Dname, ed.d.Loc })
                    .Where(ed => ed.Count() == 5)
                    .Select(ed => new Dept()
                    {
                        Deptno = ed.Key.Deptno,
                        Dname = ed.Key.Dname,
                        Loc = ed.Key.Loc
                    })
                    .OrderBy(d => d.Dname);
    ...
    {
        public static IEnumerable<Emp> TaskGetListOfSubordinates(this IEnumerable<Emp> emps)
        {
            return emps
